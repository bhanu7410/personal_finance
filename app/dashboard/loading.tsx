...
export default function DashboardLoading() {
    return (
        <div className="flex h-screen overflow-hidden bg-gray-50">
            {/* 
                We include the Sidebar here so it stays visible immediately 
                and doesn't cause a layout shift when the real page loads.
            */}
                    ...
                    <div className="flex min-h-0 flex-col gap-6">
                        ...
                        <div className="flex min-h-0 flex-1 animate-pulse flex-col rounded-xl border border-gray-200 bg-white p-5 shadow-sm">
                            ...
                            <div className="flex flex-1 items-center justify-center">
                                {/* Simulating a pie chart with a circle */}
